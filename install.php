<?php
if (!file_exists(__DIR__."/private"))
	mkdir(__DIR__."/private");
if (!file_exists(__DIR__."/private/article.db"))
{
	$ar = array();
	$ar["id"] = 1;
	$ar["name"] = "Shaq-fu";
	...
	$arr[] = $ar;
	file_put_contents(__DIR__."/private/article.db", serialize($arr));
	$arr = unserialize(file_get_contents(__DIR__."/private/article.db"));
	$ar["id"] = 2;
...
if (!file_exists(__DIR__."/private/user.db"))
{
	$ar1 = array();
	$ar1["login"] = "admin";
	...
	$ar1["access"] = 1;
	$arr1[] = $ar1;
	file_put_contents(__DIR__."/private/user.db", serialize($arr1));
	$ar1["login"] = "coucou";
	$ar1["passwd"] = hash("whirlpool", "admin");
	$ar1["access"] = 0;
	$arr1[] = $ar1;
...
if (!file_exists(__DIR__."/private/histo.db"))
	file_put_contents(__DIR__."/private/histo.db", "");
else
